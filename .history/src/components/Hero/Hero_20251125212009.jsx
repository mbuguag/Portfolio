...
export default function Hero() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden bg-gradient-to-br from-gray-50 via-blue-50 to-indigo-50 dark:from-gray-900 dark:via-gray-800 dark:to-gray-900"
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        />
        <div
          className="absolute bottom-1/4 left-1/2 w-96 h-96 bg-pink-300 dark:bg-pink-900 rounded-full mix-blend-multiply dark:mix-blend-soft-light filter blur-3xl opacity-20 animate-pulse"
      ...
      <div className="container relative z-10 text-center py-24 px-4">
        ...
        >
          ...
          <div className="mt-12 flex justify-center gap-6">
            ...
            <a
              href="https://linkedin.com/inmbuguag"
              target="_blank"
              rel="noopener noreferrer"
              className="p-3 bg-white dark:bg-gray-800 rounded-full shadow-md hover:shadow-xl hover:scale-110 transition-all duration-300 text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400"
              aria-label="LinkedIn"
